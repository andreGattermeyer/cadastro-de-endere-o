...
public class EnderecoController {
    ...
    public ResponseEntity<Endereco> obterPorCep(@PathVariable String cep) {
        Optional<Endereco> enderecoOptional = enderecoService.obterPorCep(cep);
...
public String deleteByCep(@PathVariable String cep) {
    enderecoService.deletarPorCep(cep);
    return "Endereco com CEP: " + cep + " foi deletado com sucesso!";
}
